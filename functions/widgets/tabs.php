...
class Pyre_Tabs_Widget extends WP_Widget {
	...
	function Pyre_Tabs_Widget()
	{
		...
		$this->WP_Widget('pyre_tabs-widget', 'MicroMedia Tabs', $widget_ops, $control_ops);
	}
		...
		<div class="tab-holder">
			<div class="tab-hold tabs-wrapper">
				<ul id="tabs" class="tabset tabs">
					...
					<li><a href="#tab3"><img src="<?php bloginfo('template_directory'); ?>/functions/widgets/images/speech-bubble.png" alt="Comments" /></a></li>
					<?php endif; ?>
				</ul>
