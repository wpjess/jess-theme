...
function optionsframework_init() {
	...
	if ( $optionsfile = locate_template( array('/functions/admin/options.php') ) ) {
		require_once($optionsfile);
	}
	else if (file_exists( dirname( __FILE__ ) . '/functions/admin/options.php' ) ) {
		require_once dirname( __FILE__ ) . '/functions/admin/options.php';
	}
