...
///////////////////////////////////////////////////////////////
///////////////  FETCH THE CUSTOM META BOXES //////////////////
/////////////  INCLUDES COLOR PICKER AND DATE PICKER //////////
////////////  FILES ARE IN POST-TYPES/METABOX/   //////////////
///////////////////////////////////////////////////////////////
...
// Create a new metabox file for each set.  Include each file below
require_once(TEMPLATEPATH . '/post-types/metabox/example-functions.php');
require_once(TEMPLATEPATH . '/post-types/metabox/products-meta.php');
...
function cmb_initialize_cmb_meta_boxes() {
	...
	require_once(TEMPLATEPATH . '/post-types/metabox/init.php');
}
...
<? $product_rod_small = str_replace('.png', '-675x79.png' , $product_rod);  ?>
...
require_once(TEMPLATEPATH . '/post-types/projects.php');
...
function admin_init(){
  add_meta_box("brands_meta", "Brand Info", "brands_meta", "brands", "normal", "low");
  add_meta_box("tabs_meta", "Tab Info", "tabs_meta", "hometabs", "normal", "low");
}
...
return $post_id;
  ...
  update_post_meta($post->ID, "slides_url", $_POST["slides_url"]);
  update_post_meta($post->ID, "slides2_url", $_POST["slides2_url"]);
}
}
...
///////////////////////////////////////////////////////////////
///////////////  FETCH THE CUSTOM META BOXES //////////////////
///////////////////  HAS REPEATABLE FIELDS  ///////////////////
///////////////////////////////////////////////////////////////

// upload the /wpalchemy/ folder to the wp-content directory
...
<!-- in theme files -->
<?php echo of_get_option('linkedin_link'); ?>
...
require_once(TEMPLATEPATH . '/functions/widgets/social_links.php');
     // http://www.mmstudio.org/custom-widget-social-media-icons/
require_once(TEMPLATEPATH . '/functions/widgets/tabs.php');
     // http://www.mmstudio.org/custom-widget-sidebar-tabs/
...
// http://www.mmstudio.org/limit-the-content-by-number-of-words
///////////////////////////////////////////////////////////////
